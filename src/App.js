  ...
  return (
    <article className='bio'>
      ...
      <div className='bio__soft-skills soft-skills'>
        <h2 className='soft-skills__title title'>{title}</h2>
...
const Interests = memo(({ title, interests }) => {
  return (
    <div className='interests'>
      <h2 className='interests__title title'>{title}</h2>
...
const Development = memo(({ title, development }) => {
  return (
    <div className='development'>
      <h2 className='development__title title'>{title}</h2>
...
const Skills = memo(({ title, skills }) => {
  return (
    <div className='skills'>
      <div className='skill__title title'>{title}</div>
...
const Projects = memo(
  ({ cards, setIsModalOpen, setModalInfo, filtredCards }) => {
    return (
...
const Represent = memo(({ formInner }) => {
  const getTime = () => {
    let date = new Date();
  ...
  return (
    <div className='represent__lines --active'>
      <div className='line'>
            ...
            <div className='about-page__content'>
              ...
              <section
                className={`info__content ${
                  activeInfo && `info__${activeInfo}`
                }`}
              >
                {activeInfo === 'bio' && <Bio {...data.info.bio} />}
                {activeInfo === 'interests' && (
                  <Interests {...data.info.interests} />
                )}
                {activeInfo === 'education' && <Education {...data.info} />}
                {activeInfo === 'development' && (
                  <Development {...data.info.development} />
                )}
                {activeInfo === 'skills' && <Skills {...data.info.skills} />}
              </section>
            </div>
